...
import 'animation_bottom_bar_controller.dart';

/// Class to generate the NotchBottomBar
class AnimatedBottomBar extends StatefulWidget {
  /// Controller for animation
  final AnimationBottomBarController notchBottomBarController;
...
class _AnimatedBottomBarState extends State<AnimatedBottomBar> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Use CurvedAnimation to apply a curve to the animation
